...
describe('Preferences Routes', () => {
  ...
  it('GET / should return preferences', async () => {
    service.getPreferences.mockResolvedValue({ colorScheme: 'light', language: 'en', toolCollapseMode: 'expanded' });
  ...
  it('PUT / should update preferences', async () => {
    service.updatePreferences.mockResolvedValue({ colorScheme: 'dark', language: 'en', toolCollapseMode: 'expanded' });
